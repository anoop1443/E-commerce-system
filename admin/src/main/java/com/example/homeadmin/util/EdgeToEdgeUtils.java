package com.example.homeadmin.util;
...
public class EdgeToEdgeUtils {
    ...
    /**
     * Applies ONLY the top inset (status bar) as padding to the given view, adding to existing padding.
     */
    ...
    /**
     * Applies ONLY the bottom inset (navigation bar) as padding to the given view, adding to existing padding.
     */
