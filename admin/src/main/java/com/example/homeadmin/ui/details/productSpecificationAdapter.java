...
import static com.example.homeadmin.ui.details.productSpecificationModel.GENERAL_TEXT_VIEW;
import static com.example.homeadmin.ui.details.productSpecificationModel.MORE_INFO_DETAILS;
import static com.example.homeadmin.ui.details.productSpecificationModel.SPECIFICATION_DETAILS;
...
public class productSpecificationAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (productSpecificationModelList.get(position).getViewType()){
            case GENERAL_TEXT_VIEW:
                String only = productSpecificationModelList.get(position).getGenerateText();
            ...
            case MORE_INFO_DETAILS:
                String moreInfoTitle = productSpecificationModelList.get(position).getMoreInfoTitle();
                String moreInfoBody = productSpecificationModelList.get(position).getMoreInfoBody();
                String  imageUrl = productSpecificationModelList.get(position).imageLogo;
                ((MoreInfo)holder).setMore(moreInfoTitle,moreInfoBody,imageUrl);
                break;
            default:
                return;
    ...
    public class MoreInfo extends RecyclerView.ViewHolder{
        ...
        private void setMore(String moreInfoTitle, String moreInfoBody, String imageUrl){
            Manufacture.setText(moreInfoTitle);
            ManufactureAdd.setText(moreInfoBody);
        }
    }
}
