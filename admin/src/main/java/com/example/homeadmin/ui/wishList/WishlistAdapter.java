...
import static com.example.homeadmin.ui.details.ProductDetailsActivity.running_wishlist_query;
import static com.example.homeadmin.ui.wishList.Wishlist_Fragment.loadingDialog;
...
public class WishlistAdapter extends RecyclerView.Adapter<WishlistAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        double freeCoupon = wishlistModelList.get(position).getFreeCoupon();
