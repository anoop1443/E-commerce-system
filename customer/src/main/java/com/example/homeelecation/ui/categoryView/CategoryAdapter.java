...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        String id = categoryModelList.get(position).getCategoryId();
        String icon = categoryModelList.get(position).getCategoryIconLink();
        String name = categoryModelList.get(position).getCategoryName();
        viewHolder.setCategory(id, name);
    ...
    public void updateList(List<CategoryModel> categoryList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setCategoryIcon(String iconUrl){
            Glide.with(itemView.getContext()).load(iconUrl).apply(new RequestOptions().placeholder(R.drawable.empty_img)).into(categoryIcon);
            ...
            if (!name.equals("")) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        categoryClass.putExtra("CategoryId", id);
