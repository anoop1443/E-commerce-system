...
class ApiClient {
  ...
  public <T extends Entity> T get(String version, String path, JSONObject requestObject) throws RazorpayException, JSONException {
    return get(version, path, requestObject, Constants.API);
  }

  public <T extends Entity> T get(String version, String path, JSONObject requestObject, String host) throws RazorpayException, JSONException {
    Response response = ApiUtils.getRequest(version, path, requestObject, auth, host);
    return processResponse(response);
  }

  public <T> T post(String version, String path, JSONObject requestObject) throws RazorpayException, JSONException {
    return post(version, path, requestObject, Constants.API);
  }

  public <T> T post(String version, String path, JSONObject requestObject, String host) throws RazorpayException, JSONException {
    Response response = ApiUtils.postRequest(version, path, requestObject, auth, host);
    return processResponse(response);
  }

  public <T extends Entity> T put(String version, String path, JSONObject requestObject) throws RazorpayException, JSONException {
    return put(version, path, requestObject, Constants.API);
  }

  public <T extends Entity> T put(String version, String path, JSONObject requestObject, String host) throws RazorpayException, JSONException {
    Response response = ApiUtils.putRequest(version, path, requestObject, auth, host);
    return processResponse(response);
  }

  public <T extends Entity> T patch(String version, String path, JSONObject requestObject) throws RazorpayException, JSONException {
    return patch(version, path, requestObject, Constants.API);
  }

  public <T extends Entity> T patch(String version, String path, JSONObject requestObject, String host) throws RazorpayException, JSONException {
  ...
  public <T> T delete(String version, String path, JSONObject requestObject) throws RazorpayException, JSONException {
    Response response = ApiUtils.deleteRequest(version, path, requestObject, auth);
    return processDeleteResponse(response);
  }

  private <T extends Object> T processDeleteResponse(Response response) throws RazorpayException, JSONException {
    if (response == null) {
  ...
  private <T extends Entity> T parseResponse(JSONObject jsonObject, String entity) throws RazorpayException {
    if (entity != null) {
      ...
      if (cls== null){
        throw new RazorpayException("Unable to parse response 1");
      }
      try {
  ...
  <T extends Object> T processResponse(Response response) throws RazorpayException, JSONException {
    if (response == null) {
      throw new RazorpayException("Invalid Response from server");
    }
  ...
  private String  getEntity(JSONObject jsonObj, HttpUrl url) throws JSONException {
  ...
  private Class<?> getClass(String entity) {
    try {
      String entityClass = "com.example.homeelecation.ui.razorpay." + WordUtils.capitalize(entity, '_').replaceAll("_", "");
