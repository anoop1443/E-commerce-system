...
public class PaymentClient extends ApiClient {
  ...
  public BankTransfer fetchBankTransfers(String id) throws RazorpayException, JSONException {
    return get(Constants.VERSION, String.format(Constants.PAYMENT_BANK_TRANSFER_GET, id), null);
  }

  public Payment edit(String id, JSONObject request) throws RazorpayException, JSONException {
    return patch(Constants.VERSION, String.format(Constants.PAYMENT_EDIT, id), request);
  }
  
  public List<Payment> fetchPaymentDowntime() throws RazorpayException, JSONException {
    return getCollection(Constants.VERSION, Constants.FETCH_DOWNTIME_LIST, null);
  }

  public Payment fetchPaymentDowntimeById(String id) throws RazorpayException, JSONException {
    return get(Constants.VERSION, String.format(Constants.FETCH_DOWNTIME_GET, id), null);
  }

  public Payment createJsonPayment(JSONObject request) throws RazorpayException, JSONException {
    return post(Constants.VERSION, Constants.PAYMENT_JSON_CREATE, request);
  }

  public Payment createRecurringPayment(JSONObject request) throws RazorpayException, JSONException {
    return post(Constants.VERSION, Constants.PAYMENT_RECURRING, request);
  }

  public Payment otpGenerate(String id) throws RazorpayException, JSONException {
    return post(Constants.VERSION, String.format(Constants.PAYMENT_OTP_GENERATE, id), null);
  }

  public Payment otpSubmit(String id, JSONObject request) throws RazorpayException, JSONException {
    return post(Constants.VERSION, String.format(Constants.PAYMENT_OTP_SUBMIT, id), request);
  }

  public Payment otpResend(String id) throws RazorpayException, JSONException {
    return post(Constants.VERSION, String.format(Constants.PAYMENT_OTP_RESEND, id), null);
  }
  public Payment createUpi(JSONObject request) throws RazorpayException, JSONException {
    return post(Constants.VERSION, Constants.PAYMENT_CREATE_UPI, request);
  }
  public Payment validateUpi(JSONObject request) throws RazorpayException, JSONException {
    return post(Constants.VERSION, Constants.VALIDATE_VPA, request);
  }

  public Payment expandedDetails(String id, JSONObject request) throws RazorpayException, JSONException {
    return get(Constants.VERSION, String.format(Constants.PAYMENT_GET, id), request);
  }
  public Methods fetchPaymentMethods() throws RazorpayException, JSONException {
